    ...
    <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Select
                    value={formData.type}
                    onValueChange={(val: PaymentType) => setFormData({ ...formData, type: val })}
                  >
                    <SelectTrigger className="col-span-3">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div
              className={`text-2xl font-bold ${netBudget >= 0 ? 'text-green-600' : 'text-red-600'}`}
            >
              $
              {netBudget.toLocaleString('en-US', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
              })}
            </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-500">
              -$
              {summary.mtdSpending.toLocaleString('en-US', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
              })}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-500">
              -$
              {summary.ytdSpending.toLocaleString('en-US', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
              })}
            </div>
            ...
            <TableBody>
              {payments.map(payment => (
                <TableRow key={payment.id}>
                  ...
                  <TableCell>
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${payment.type === PaymentType.INCOME ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}
                    >
