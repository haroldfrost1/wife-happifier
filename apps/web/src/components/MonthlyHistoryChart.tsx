...
export const MonthlyHistoryChart: React.FC<MonthlyHistoryChartProps> = ({ data }) => {
  ...
  useEffect(() => {
    ...
    // Color palette
    const color = d3.scaleOrdinal().domain(subgroups).range(['#22c55e', '#ef4444']); // Green for income, Red for expense
